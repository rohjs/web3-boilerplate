...
import { getTrustWalletProvider } from 'lib/wagmi/connectors/trustWallet'
...
export const metamaskWalletConfig = {
  ...
  deepLink: `https://metamask.app.link/dapp/${config.domain}`,
  downloadLink:
    isMobile && isIOS
...
export const trustWalletConfig = {
  ...
  deepLink: `https://link.trustwallet.com/open_url?coin_id=637&url=${config.domain}`,
  downloadLink:
    isMobile && isIOS
